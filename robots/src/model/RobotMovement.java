...
public class RobotMovement {
    ...
    public RobotMovement(TargetData target){
        targetData = target;
    }
    ...
    {
        double distance = distance(targetData.getTargetPositionX(), targetData.getTargetPositionY(),
        ...
        double angleToTarget = angleTo(robot.getRobotPositionX(),
                robot.getRobotPositionY(), targetData.getTargetPositionX(), targetData.getTargetPositionY());
