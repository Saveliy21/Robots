...
// robot и robotMovement и TargetData -> Model (mvp)
//
...
public class GameVisualizer extends JPanel
{
    ...
    public void paint(Graphics g)
    {
        ...
        drawRobot(g2d, RobotMovement.round(robot.getRobotPositionX()),
                RobotMovement.round(robot.getRobotPositionY()), robot.getRobotDirection());
        if(target != null){
    ...
    {
        int robotCenterX = RobotMovement.round(x);
        int robotCenterY = RobotMovement.round(y);
